...
`
      ...
      generarReporteProfesional(
        'Reporte Diario de Ventas y Cierre de Cajas',
        columnas,
        datosTabla,
        stringTotales
      )
  ...
  const handleReportePlatos = async () => {
    ...
    try {
      ...
      const platosStats: Record<
        string,
        { cantidad: number; recaudado: number; categoria: string }
      > = {}
      ...
      generarReporteProfesional(
        ...
        ['Nombre del Plato', 'Categoría', 'Cant. Vendida', 'Total Recaudado'],
        datosTabla
      )
  ...
  const REPORTS_LIST = [
    {
      ...
      description: 'Resumen de todas las ventas, propinas y descuentos del día.',
      icon: FileText,
      action: handleReporteVentas
    },
    {
      id: 2,
      name: 'Rendimiento de Meseros',
      description: 'Estadísticas de mesas atendidas y ventas por personal.',
      icon: FileText,
      action: handleReporteMeseros
    },
    {
      id: 3,
