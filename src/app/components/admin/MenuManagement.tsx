      ...
      if (editingId) {
            ...
            d.id === editingId
              ? {
                  ...
                  category:
                    ...
                    platoActualizado.categoria !== null
        ...
        setDishes([
          ...dishes,
          {
            ...
            category:
              typeof platoCreado.categoria === 'object' && platoCreado.categoria !== null
  ...
  return (
    <>
      <header className="px-4 sm:px-6 lg:px-10 py-6 lg:py-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 sticky top-0 bg-[#FCE4D6]/90 backdrop-blur-md z-10">
        <div>
          <h1 className="text-3xl lg:text-4xl font-bold text-[#4B2E2D] mb-1 lg:mb-2">
            Gestión de Menú
          </h1>
          <p className="text-[#4B2E2D]/70 font-medium text-sm lg:text-base">
            Administra las opciones de tu menú y su disponibilidad
          </p>
        </div>
        <button
        ...
        <div className="overflow-x-auto pb-1 -mb-1">
          <div className="flex items-center gap-2 min-w-max">
            ...
            >
              Todos{' '}
              <span
                className={`inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-[11px] font-black transition-colors ${menuFilter === 'all' ? 'bg-white/25 text-white' : 'bg-[#FCE4D6] text-[#D0543A]'}`}
              >
                {dishes.length}
              </span>
            </button>
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  {cat.label}{' '}
                  <span
                    className={`inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-[11px] font-black transition-colors ${menuFilter === cat.id ? 'bg-white/25 text-white' : 'bg-[#FCE4D6] text-[#D0543A]'}`}
                  >
                    {count}
                  </span>
                </button>
                ...
                {categoryDishes.length > 0 ? (
                  <>
                      ...
                      {categoryDishes.map((dish) => (
                        ...
                        >
                          ...
                          <div className="p-6 flex flex-col flex-1">
                            <h3 className="text-xl font-black text-[#4B2E2D] leading-tight mb-1 line-clamp-1">
                              {dish.name}
                            </h3>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 text-sm font-bold text-[#D0543A] hover:bg-[#D0543A]/8 px-4 py-2 rounded-lg transition-all w-fit"
                    >
                      <Plus size={14} strokeWidth={2.5} /> Añadir al menú
                    </button>
                  </>
                ) : (
                  <div className="py-8 sm:py-10 flex flex-col items-center text-center bg-white/60 rounded-2xl border-2 border-dashed border-[#E57C5D]/20">
                    ...
                    <p className="text-[#4B2E2D]/45 font-medium text-sm mb-3">
                      Esta categoría aún no tiene platos
                    </p>
                    <button
                      onClick={() => handleOpenAddModal(category.id)}
            ...
            <form className="space-y-5" onSubmit={handleSaveDish}>
                  ...
                  {isUploading ? (
                    ...
                    <div className="absolute inset-0">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 hover:opacity-100 transition-opacity">
                        <span className="text-white font-bold px-4 py-2 bg-[#D0543A] rounded-lg shadow-lg">
                          Cambiar Foto
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center h-full">
                      <CloudUpload
                        size={48}
                        className="text-[#E57C5D] mb-3 group-hover:scale-110 transition-transform"
                      />
                      <span className="text-[#4B2E2D] font-medium text-center">
              ...
              <div className="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-[#FCE4D6]">
                ...
                <button
                  type="submit"
                  disabled={isUploading}
                  className={`px-8 py-3 text-white font-bold rounded-xl shadow-lg transition-all ${isUploading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#D0543A] hover:bg-[#b5462f] hover:shadow-xl active:scale-[0.98]'}`}
                >
                  Guardar
                </button>
              </div>
