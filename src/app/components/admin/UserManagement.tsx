      ...
      <header className="px-10 py-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sticky top-0 bg-[#FCE4D6]/90 backdrop-blur-md z-10">
        <div>
          ...
          <p className="text-[#4B2E2D]/70 font-medium">
            Administra las cuentas del personal (Conectado a DB)
          </p>
        </div>
        <button
          ...
          <div className="overflow-x-auto">
              ...
              <tbody>
                {users.map((user) => {
                  ...
                  return (
                    <tr
                      key={user._id}
                      className="border-b border-[#FCE4D6] hover:bg-[#FCE4D6]/20 transition-colors"
                    >
                      ...
                      <td className="py-5 px-6">
                        <div className="flex items-center gap-3">
                          ...
                          >
                            <div
                              className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-300 ${user.estado ? 'translate-x-6' : 'translate-x-0'}`}
                            ></div>
                          </button>
                          <span
                            className={`text-sm font-bold ${user.estado ? 'text-[#E57C5D]' : 'text-gray-400'}`}
                          >
            ...
            {users.length === 0 && (
              <div className="py-16 flex flex-col items-center text-center">
                ...
                <p className="font-bold text-[#4B2E2D] text-lg">
                  No hay usuarios en la base de datos
                </p>
                <p className="text-[#4B2E2D]/60 font-medium mt-1">
                  Asegúrate de que tu backend está corriendo y usa el botón para agregar personal
                </p>
              </div>
            )}
          </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white w-full max-w-[520px] border-[6px] border-[#4B2E2D] rounded-3xl p-8 relative my-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <h2 className="text-3xl font-bold text-[#4B2E2D] mb-6">
              {userEditingId ? 'Editar Usuario' : 'Nuevo Usuario'}
            </h2>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#FCE4D6] w-full max-w-[400px] border-4 border-[#D0543A] rounded-3xl p-8 relative shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col items-center text-center">
            ...
            <p className="text-[#4B2E2D]/80 mb-8 leading-relaxed font-medium">
              Esta acción eliminará la cuenta del usuario permanentemente de la Base de Datos y no
              se puede deshacer.
            </p>
